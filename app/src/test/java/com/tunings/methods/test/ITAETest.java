...
public class ITAETest
{
	...
	public void computeRegulatorPI()
	{
		...
		// Calculated values.
		ControllerParameters sut = ITAE.Compute(ControlType.PI, ControlProcessType.Regulator, Gain, TimeConstant, TransportDelay);
	...
	public void computeRegulatorPID()
	{
		...
		// Calculated values.
		ControllerParameters sut = ITAE.Compute(ControlType.PID, ControlProcessType.Regulator, Gain, TimeConstant, TransportDelay);
		assertEquals("Check Kp parameters", expectedParameters.getKP(), sut.getKP(), 0.01);
		assertEquals("Check Ki parameters", expectedParameters.getKI(), sut.getKI(), 0.01);
		assertEquals("Check Kd parameters", expectedParameters.getKD(), sut.getKD(), 0.01);
	}
	...
	public void computeServoPI()
	{
		...
		// Calculated values.
		ControllerParameters sut = ITAE.Compute(ControlType.PI, ControlProcessType.Servo, Gain, TimeConstant, TransportDelay);
		assertEquals("Check Kp parameters", expectedParameters.getKP(), sut.getKP(), 0.01);
		assertEquals("Check Ki parameters", expectedParameters.getKI(), sut.getKI(), 0.01);
		assertEquals("Check Kd parameters", expectedParameters.getKD(), sut.getKD(), 0.01);
	}
	...
	public void computeServoPID()
	{
		...
		// Calculated values.
		ControllerParameters sut = ITAE.Compute(ControlType.PID, ControlProcessType.Servo, Gain, TimeConstant, TransportDelay);
		assertEquals("Check Kp parameters", expectedParameters.getKP(), sut.getKP(), 0.01);
		assertEquals("Check Ki parameters", expectedParameters.getKI(), sut.getKI(), 0.01);
		assertEquals("Check Kd parameters", expectedParameters.getKD(), sut.getKD(), 0.01);
	}
